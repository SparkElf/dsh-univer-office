...
- **Review-card viewport** — an expanded desktop card is about 650px tall by default. Its embedded full Univer page starts with the left sidebar collapsed and can still be expanded from inside the page.
