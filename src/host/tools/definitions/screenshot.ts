...
async function assertImageCapableRoute(
  ctx: Context,
  exec: { readonly agent?: { readonly session: { requestHeader(): { readonly config?: { readonly provider?: string; readonly model?: string } } | undefined }; readonly options: { readonly provider?: string; readonly model?: string } }; readonly signal: AbortSignal },
  file: string,
): Promise<void> {
